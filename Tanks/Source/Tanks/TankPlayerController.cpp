...
void ATankPlayerController::SetupInputComponent() {
	...
	InputComponent->BindAction("FireTypeChange", EInputEvent::IE_Pressed, this, &ATankPlayerController::FireTypeChange);
	InputComponent->BindAction("SetFireAlternative", EInputEvent::IE_Pressed, this, &ATankPlayerController::SetFireAlternative);
} 
...
void ATankPlayerController::FireTypeChange()
{
	if (TankPawn) {
		TankPawn->FireTypeChange();
	}
}

void ATankPlayerController::SetFireAlternative() {
	if (TankPawn) {
		TankPawn->SetFireAlternative();
	}
}
